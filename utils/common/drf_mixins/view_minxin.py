...
from utils.common.views_base.view_base import MyViewBase
...
# *                                                                             *
# *******************************************************************************
class MyCreateModeMixin(CreateModelMixin,GenericViewSet,MyViewBase):
...
class MyDeleteModelMixin(DestroyModelMixin,GenericViewSet,MyViewBase):
...
class MyUpdateModelMixin(UpdateModelMixin,GenericViewSet,MyViewBase):
...
class MyListModelMixin(ListModelMixin,GenericViewSet,MyViewBase):
...
class MyRetrieveModelMixin(RetrieveModelMixin,GenericViewSet,MyViewBase):
...
class MyAPIView(APIView,MyViewBase):
